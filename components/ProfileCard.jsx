  ...
  return (
    <div className=" lg:self-end flex flex-row lg:w-2/3 h-fit mx-2 items-center"> 
      <div className="flex flex-col text-sm tracking-tight text-gray-100  my-2  w-fit">
        <h1 className="text-5xl text-slate-200 mb-4 font-bold font-display tracking-tight w-fit">{user?.name}</h1>
        <h2 className="text-xl text-slate-200 mb-5 font-display font-medium w-fit">{user?.occupation}</h2>
